...
const TEXTS_ZH = {
  ...
  catCommunity: "社區討論",
  subAiNews: "AI 媒體",
  subTrendingPapers: "熱門論文",
  subXViral: "X 推文",
  subBlogWeekly: "博客週刊",
  subCnCommunity: "中文社區",
  subOverseasCommunity: "海外社區",
  subFinanceNews: "財經新聞",
  subFinanceCommunity: "社區討論",
  subWorld: "國際要聞",
  subOverseasNews: "海外科技",
  subOverseas: "海外",
  emptySource: "該源今日無內容。",
  emptyCategory: "該分類今日無內容。",
  emptyGroup: "該組今日無數據。",
  footer: "內容均來自原媒體，本站僅作摘要整理與回鏈。",
  summaryLabelNews: "中文摘要",
  summaryLabelIntro: "中文介紹",
  tradingMarketOverview: "市場總覽",
  tradingTodayFocus: "今日關注",
  tradingAllAssets: "全部資產",
  tradingRiskCaveat: "風險提示",
  widgetCryptoFearGreed: "加密恐慌貪婪",
  widgetCryptoCap: "加密總市值",
  widgetBtcDom: "BTC 主導率",
  widgetVolume24h: "24h 成交量",
  widgetActiveCoins: "活躍幣",
  ticker5d: "5 日",
  ...
  trendBearish: "空頭",
  trendNeutral: "中性",
  mdTodayOverview: "今日總覽",
  mdEditorNote: "編輯短評",
  mdTodayKeywords: "今日關鍵詞",
  mdImportance: "重要度",
  archiveLink: "← 歷史歸檔",
};
...
function formatDate(d: Date | undefined): string {
  ...
  try {
    ...
    const localeTag = REPORT_LOCALE === "en" ? "en-GB" : "zh-TW";
...
export function renderHtml(
  ...
  return `<!doctype html>
<html lang="${REPORT_LOCALE === "en" ? "en" : "zh-TW"}">
<head>
<meta charset="utf-8">
